  ...
  return (
    <div className="space-y-1.5 w-full">
      ...
      <div className="relative">
        ...
        <input
          id={id}
          className={`w-full ${icon ? "pl-12" : "px-4"} ${endIcon ? "pr-12" : "pr-4"} py-3.5 bg-white dark:bg-zinc-800/40 border ${error
        ...
        />
        {endIcon && (
          <div className="absolute inset-y-0 right-0 pr-4 flex items-center text-zinc-400 dark:text-zinc-500">
            {endIcon}
          </div>
        )}
      </div>
