        ...
        <>
          ...
          <div className="relative">
            <button
              ...
              className="text-zinc-450 hover:text-zinc-650 cursor-pointer dark:hover:text-zinc-200 p-1.5 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            ...
            {showActionsMenu && (
              <>
                ...
                <div className="absolute right-0 mt-1.5 w-50 bg-white dark:bg-zinc-850 border border-zinc-200/60 dark:border-zinc-800 rounded-xl shadow-lg py-1.5 z-50 animate-fade-in text-[16px] font-medium text-zinc-700 dark:text-zinc-200">
                  <button
                    type="button"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-left hover:bg-red-50 dark:hover:bg-red-950/20 text-[#F14D4D] dark:text-red-400 flex items-center gap-2 cursor-pointer transition-colors border-t border-zinc-100 dark:border-zinc-800/60 mt-1 pt-1.5"
                  >
        ...
        <InfoCell
          icon={
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M6 21V19C6 17.9391 6.42143 16.9217 7.17157 16.1716C7.92172 15.4214 8.93913 15 10 15H14C15.0609 15 16.0783 15.4214 16.8284 16.1716C17.5786 16.9217 18 17.9391 18 19V21M8 7C8 8.06087 8.42143 9.07828 9.17157 9.82843C9.92172 10.5786 10.9391 11 12 11C13.0609 11 14.0783 10.5786 14.8284 9.82843C15.5786 9.07828 16 8.06087 16 7C16 5.93913 15.5786 4.92172 14.8284 4.17157C14.0783 3.42143 13.0609 3 12 3C10.9391 3 9.92172 3.42143 9.17157 4.17157C8.42143 4.92172 8 5.93913 8 7Z" stroke="#0077FF" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          }
          label="Customer Name"
