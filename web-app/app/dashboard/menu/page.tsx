...
import MenuDetailView, {
  type MenuDetailModifierGroup,
} from "../../../components/menu/MenuDetailView";
import {
  FULFILLMENT_TYPES,
  MENU_CATEGORIES,
...
const DEFAULT_MODIFIER_GROUPS: MenuDetailModifierGroup[] = [
  {
    id: "mg-1",
    name: "Cooking Style",
...
// Default Seed Dishes matching Screenshot 2 perfectly!
