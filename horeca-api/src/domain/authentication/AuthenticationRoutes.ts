...
import { changePasswordSchema } from "./AuthenticationMiddleware";
...
router.post("/change-password", verifyJWT_MW, validateSchema(changePasswordSchema), controller.changePassword);
